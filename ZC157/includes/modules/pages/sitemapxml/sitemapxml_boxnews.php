...
//define undfine tables 
if (!defined('TABLE_BOX_NEWS')) define('TABLE_BOX_NEWS', DB_PREFIX . 'box_news');
if (!defined('TABLE_BOX_NEWS_CONTENT')) define('TABLE_BOX_NEWS_CONTENT', DB_PREFIX . 'box_news_content');
